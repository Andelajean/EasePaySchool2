            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        Question 2: Comment Acceder Dans le Compte de Mon Ecole?
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionHelp">
                    <div class="accordion-body">
                        Pour acceder dans votre tableau de bord (compte pour votre ecole) créer tout d'aorb un compte pour votre ecole et sauvegarder votre identifiant qui vous sera remis lors de la création de votre compte , puis cliquez sur "Telecharger" pour telecharger l'application desktop.  Apres le telechargement de l'application , demarrer la , une page s'affichera pour vous demander votre identifiant , mettez l'identifiant obtenu lors de la création du compte pour votre ecole , puis créez un compte pour utilisateur.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
