...
<style>
    ...
    <title>EasePayShool - A Propos</title>
  </head>
  <body>
   ...
   <div id="app-content">  
    ...
    <img src="{{ asset('img/logofin.jpg') }}" class="circular-logo" alt="Logo">
     <ul class="nav-links">
      ...
      <div class="container section-inf" data-aos="fade-up">
        <h2 id="easePayTitle"></h2>
        <p>EasePaySchool est une plateforme innovante conçue pour faciliter les paiements scolaires. Elle evite aux parents de se deplacer pour presenter les réçus dans les établissements. Les écoles peuvent gérer les paiements de manière efficace et suivre les transactions en temps réel.</p>
        <div class="button-container">
             <a href="{{route('ecole.compte')}}"><button class="btn btn-primary" >CREER UN COMPTE POUR MON ECOLE</button> </a>
            <a href="{{route('pay.help')}}"> <button class="btn btn-secondary" >TRouver de l'aide </button> </a>
        </div>
    </div>
     <!-- fin de c'est quoi  -->
...
<section class="ceo-section">
        <div class="text-container">
            <h2 id="ceo"></h2>
            <p>Le CEO de EasePaySchool est Jean Geal ANDELA, un leader visionnaire. Sous sa direction, EasePaySchool a révolutionné la gestion des paiements scolaires.</p>
        </div>
        <div class="image-container">
            <img src="{{ asset('img/ceo2.jpg') }}" alt="CEO of EasePaySchool">
        </div>
</section>
      <!-- footer -->
      <footer>
